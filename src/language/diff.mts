...
export const diff: LanguagePattern[] = [
  ...
  {
    regex:
      /\b(const|try|var|return|if|else|while|for|switch|break|catch|continue|struct|enum|pub|use|extern|export|inline|noalias|align|defer|fn)\b/g,
    className: "keyword",
  },
  { regex: /\b(true|false|null)\b/g, className: "boolean" },
  {
    regex:
      /\b(?:u\d+|i\d+|f\d+|bool|void|noreturn|type|isize|usize|c_void|c_int|c_long|c_ulong|c_float|c_double)\b/g,
    className: "type",
  },
